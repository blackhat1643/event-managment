...
class Mdl_appointment_time extends CI_Model
  ...
  private $_table = 'tbl_appointment_time';
...
public function get_all_with_pagi($id,$limit = 10,$start = 0,$w="") 
  {
    ...
    public function get_count($w = null) {
        $query="SELECT * FROM tbl_appointment_time WHERE is_deleted = '0' $w ORDER BY id DESC";
            $TotalData = ORM::for_table('tbl_appointment_time')->raw_query($query)->find_array();
      $d = count($TotalData);
