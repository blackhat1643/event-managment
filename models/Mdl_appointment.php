...
class Mdl_appointment extends CI_Model{
  ...
  public function get_all_with_pagi($id,$limit = 10,$start = 0,$w="") 
  {
    ...
    $query = "SELECT * FROM $this->_table WHERE is_deleted = '0' AND type = 'appointment'  $w  ORDER BY id DESC $l";
  ...
  public function get_search_count($limit = 10,$w) {
      ...
      $query = "SELECT * FROM `$this->_table` WHERE is_deleted = '0' AND type = 'appointment' $w ORDER BY id DESC";
