...
class Mdl_our_packages extends CI_Model
{
	...
	public function __construct()
  {
	...
	private $_table = 'tbl_our_packages';
	...
	public function get_all_with_pagi($id,$limit = 10,$start = 0,$w="") 
	{
 	...
 	public function get_count($w = null) {
   		$query="SELECT * FROM tbl_our_packages WHERE is_deleted = '0' $w ORDER BY id DESC";
      $TotalData = ORM::for_table('tbl_our_packages')->raw_query($query)->find_array();
			$d = count($TotalData);
			if($d) { return $d; } else { return FALSE; }
	}
